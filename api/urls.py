...
urlpatterns = [
    ...
    path('accounts/<str:account_id>', AccountAPI.as_view(), name='Account'),
    ...
    path('category/<int:category_id>/notification', NotificationCategoryAPI.as_view(), name='Notification Category'),
